#!/usr/bin/env python3
"""
Personal Assistant Server with Anthropic Claude
Extends RealtimeSTT with Anthropic LLM capabilities
"""

if __name__ == '__main__':
    print("Starting Personal Assistant Server (Anthropic)...")
    import sys
    import os
    ...
    async def main():
        ...
        print(f"\n{'='*60}")
        print(f"Personal Assistant Server (Anthropic Claude)")
        print(f"{'='*60}")
        ...
        print(f"    • 'assistant mode' - Enable Claude responses")
